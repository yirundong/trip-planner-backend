...
class TripRequest(BaseModel):
    ...
    start_date: str = Field(..., description="开始日期 YYYY-MM-DD", example="2026-06-01")
    end_date: str = Field(..., description="结束日期 YYYY-MM-DD", example="2026-06-03")
...
class POIInfo(BaseModel):
    ...
    typecode: str = Field(..., description="类型代码")
    address: str = Field(..., description="地址")
